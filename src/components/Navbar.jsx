  ...
  return (
    ...
    >
      <div style={{ display: 'flex', alignItems: 'center', gap: '3rem' }}>
        ...
        <div className="status-indicator" style={{ display: 'flex', alignItems: 'center', gap: '0.8rem', fontSize: '0.7rem', color: 'var(--secondary)', fontWeight: 500, letterSpacing: '0.05em' }}>
